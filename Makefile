...
DISTDIR = /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/build/Gelin-qt1.0.0.0
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb/libleveldb.a /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb/libmemenv.a /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb/libleveldb.a; cd /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb ; $(MAKE) clean /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/secp256k1/src/libsecp256k1_la-secp256k1.o; cd /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/secp256k1; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb/libleveldb.a: FORCE
	cd /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/build/build.h: FORCE
	cd /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3; /bin/sh share/genbuild.sh /media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/build/build.h
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3 -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/json -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/qt -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/qt/plugins/mrichtexteditor -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb/include -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/leveldb/helpers -I/media/zextherabbit/Svastara/WORK/_Crypto/Crypto_Dev/Gelin3/src/secp256k1/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
