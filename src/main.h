...
static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 GLN per block has been ignored
static const int64_t TARGET_SPACING = 30; // 1,5 min per Block
...
static const int64_t MAX_MONEY = 20000000 * COIN; // 20M coins
