...
int nAnonymizeGelinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Gelin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Gelin
    // Mac: ~/Library/Application Support/Gelin
    // Unix: ~/.Gelin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Gelin";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Gelin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Gelind.pid"));
